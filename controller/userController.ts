...
export const facebookLoginCallback = (accessToken, refreshToken, profile, done) => {
...
export const editProfile = (req, res) => res.render('edit_profile', { pageTitle: 'edit_profile' });
